  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="flex w-full items-center justify-between gap-3 border border-hairline bg-night-raised/40 px-4 py-3 text-left text-sm font-light transition-colors duration-300 hover:border-hairline-strong focus:border-copper focus:outline-none"
      >
